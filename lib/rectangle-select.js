(function (global, factory) {
  ...
  function rectangleSelect(drag, x, y) {
    ...
    function interactor(selection) {
      ...
      drag.on("dragstart.select", function () {
        ...
        drag.on("drag.select", function () {
          ...
          if (m[0] !== origin[0] && m[1] !== origin[1]) {
            var xdomain = [origin[0], m[0]].map(x.invert).sort(function (a, b) {
              return a - b;
            }),
                ydomain = [origin[1], m[1]].map(y.invert).sort(function (a, b) {
              return a - b;
            }),
                new_xmin = xdomain[0],
                new_xmax = xdomain[1],
