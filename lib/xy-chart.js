(function (global, factory) {
  ...
  function xyChart(options_override) {
    ...
    var drag_legend = d3.behavior.drag().on("drag", function (d, i) {
      legend_offset.x += _d.event.dx;
      legend_offset.y += _d.event.dy;
    ...
    chart.draw_legend = function (data) {
      ...
      update_sel.enter().append('g').each(function (d, i) {
        ...
        g.append("rect").attr("width", 10).attr("height", 10).style("fill", get_series_color(null, i)).style("cursor", "move").on("mouseover", function () {
        ...
        g.append("text").attr("height", 30).attr("width", 100).style("text-anchor", "start").style("cursor", "move").style("fill", get_series_color(null, i)).on("mouseover", function () {
          chart.svg.selectAll('path.line').classed('highlight', function (d, ii) {
            return ii == i;
          }).classed('unhighlight', function (d, ii) {
            return ii != i;
