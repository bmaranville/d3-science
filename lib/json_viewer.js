(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    ...
    factory(mod.exports);
    global.json_viewer = mod.exports;
  }
  ...
  function type(i) {
    if (i === null || i === undefined) {
      ...
      throw 'unknown type for ' + String(i);
    }
  }
  ...
  function add_null(obj, name) {
    if (name != null) {
      this.append("label").text(name + ": ").classed('key', true);
    }
  ...
  function add_array(obj, name) {
    ...
    this.on("click", function () {
      d3.event.stopPropagation();var li = d3.select(this);li.classed('hidden', !li.classed('hidden'));
    });
