(function (global, factory) {
  ...
  function xSliceInteractor(state, x, y) {
    ...
    function interactor(selection) {
      ...
      var fill = group.append("rect").attr("class", "range-fill").style("stroke", "none").datum(state_to_rect(state));
      ...
      var lines_group = group.append("g").attr("class", "lines-group").style("fill", "none").style("cursor", cursor).style("stroke", state.color1).style("stroke-width", "7px");
