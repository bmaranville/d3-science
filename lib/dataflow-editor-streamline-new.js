  ...
  function editor(data) {
    ...
    */
    ...
    function module(module_data) {
      ...
      var titleborder = title.append("rect").classed("title border", true).attr("width", width).attr("height", height).attr("x", 0).attr("y", 0);
    ...
    function wire(wire_data) {
      ...
      d3.select(connector).classed("wire", true);
      return connector;
    }
    return editor;
  }
