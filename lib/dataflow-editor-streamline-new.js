  ...
  function editor(data, autosize_modules) {
    ...
    */
    ...
    function module(module_data) {
      ...
      var inputs = group.selectAll(".input").data(input_terminals).enter().append("g").classed("terminals", true).classed("input", true).attr("transform", function (d, i) {
        return "translate(-20," + (height * i).toFixed() + ")";
      });

      var outputs = group.selectAll(".output").data(output_terminals).enter().append("g").classed("terminals", true).classed("output", true).attr("transform", function (d, i) {
