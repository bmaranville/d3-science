  ...
  function heatChart(options_override) {
    ...
    function chart(selection) {
      selection.each(function (data) {
        ...
        //.style("left", "0")
        //.style("top", "0")
        .style("display", "inline-block").style("position", "relative").style("width", innerwidth + "px").style("height", innerheight + "px");
        ...
        mainview.append("g").attr("class", "x axis").append("text").attr("class", "x axis-label").attr("x", width / 2.0).attr("text-anchor", "middle").attr("y", options.margin.bottom - 15);
    ...
    chart.position_cursor = function (_) {
      ...
      if (options.position_cursor) {
        ...
        var follow = function follow() {
          ...
          position_cursor.text(x_coord.toPrecision(5) + ", " + y_coord.toPrecision(5) + ", " + parseFloat(z_coord).toPrecision(5));
        };
    ...
    chart.autofit = function () {
      ...
      chart.svg.selectAll("g.mainview g.x").attr("transform", "translate(0," + height + ")");
