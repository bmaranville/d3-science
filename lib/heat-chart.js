  ...
  function heatChart(options_override) {
    ...
    function chart(selection) {
      selection.each(function (data) {
        ...
        mainCanvas.attr("width", width).attr("height", height).attr("class", "mainplot").style("position", "absolute").style("left", "0").style("top", "0").style("width", width + "px").style("height", height + "px").style("margin-left", options.margin.left + "px").style("margin-right", options.margin.right + "px").style("margin-top", options.margin.top + "px");
