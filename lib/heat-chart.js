  ...
  function heatChart(options_override) {
    ...
    function chart(selection) {
      selection.each(function (data) {
        ...
        mainCanvas.attr("width", width).attr("height", height).attr("class", "mainplot").style("position", "absolute").style("left", options.margin.left + "px").style("top", options.margin.left + "px").style("width", width + "px").style("height", height + "px");
