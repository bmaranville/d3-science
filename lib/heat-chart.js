  ...
  function heatChart(options_override) {
    ...
    function chart(selection) {
      selection.each(function (data) {
        ...
        var svg = container.append("svg").attr("class", "mainplot").on("dblclick.resetzoom", resetzoom);
        svg.append("g").attr("class", "x axis").append("text").attr("class", "x axis-label").attr("x", width / 2.0).attr("text-anchor", "middle").attr("y", 35);
        svg.append("g").attr("class", "y axis").append("text").attr("class", "y axis-label").attr("text-anchor", "middle").attr("transform", "rotate(-90)").attr("y", -35).attr("x", -height / 2);

        svg.append("g").attr("class", "x grid");
        svg.append("g").attr("class", "y grid");
        svg.append("g").attr("class", "y interactors");
