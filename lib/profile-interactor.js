    ...
    function interactor(selection) {
      ...
      interactor.update = function () {
        ...
        edge_groups_sel.each(function (d, i) {
          ...
          edges.exit().remove();
          if (draw_extensions) {
            var left_ext = d3.select(this).selectAll('.left.extension').data([[[x.invert(-10), d[0][0][1]], d[0][0]]]).enter().append("path").classed("left extension", true);
            var right_ext = d3.select(this).selectAll('.right.extension').data([[[x.invert(x.range()[1] + 10), d.slice(-1)[0][0][1]], d.slice(-1)[0][0]]]).enter().append("path").classed("right extension", true);
          }
